...
client_obst.o: client_obst.c
	gcc -std=gnu99 -c -o client_obst.o -I/usr/include/libxml2 client_obst.c
client_move.o: client_move.c
	gcc -std=gnu99 -c -o client_move.o -I/usr/include/libxml2 client_move.c

clean:
	rm -rf server client_rad client_obst client_move *.o *.xml
